...
CREATE POLICY "Allow public insert admissions" ON students FOR INSERT TO anon USING (true);
CREATE POLICY "Allow public insert guardians" ON guardians FOR INSERT TO anon USING (true);
